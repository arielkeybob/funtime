...
| [0021](0021-security-lock.md) | Resolver duplicação de lockout de PIN em `reset.js` e extrair bloqueio/desbloqueio para `src/security/lock.js` (Fase 9.3) | aprovada |
