...
> **Arquivado** — o protocolo de migração/transição V1→V2 descrito aqui (`migration.js`,
> `transition.js`, `receiver.js`) foi removido do código na spec 0018. Preservado sem
> edição de conteúdo, só como registro histórico; veja [README.md](../../README.md) e
